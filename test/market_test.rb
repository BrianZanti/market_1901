...
class MarketTest < Minitest::Test
  ...
  def test_it_can_find_vendors_that_sell_an_item
    ...
    assert_equal [], market.vendors_that_sell("Onions")
  end

  def test_it_can_get_a_sorted_list_of_items
    market = Market.new("South Pearl Street Farmers Market")
  ...
  def test_sell_returns_false_when_no_vendors_have_the_item
    market = Market.new("South Pearl Street Farmers Market")
  ...
  def test_sell_returns_true_when_vendors_have_item_in_stock
    market = Market.new("South Pearl Street Farmers Market")
  ...
  def test_selling_reduces_vendors_stock
    market = Market.new("South Pearl Street Farmers Market")
  ...
  def test_that_it_can_sell_from_multiple_vendors
    market = Market.new("South Pearl Street Farmers Market")
